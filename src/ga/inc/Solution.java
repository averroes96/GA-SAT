...
public class Solution {
	...
	public int satisfiedClauses(Clauses clausesSet) { /* Count number of satisfied clauses by this solution */
	...
	public boolean isSolution(Clauses clausesSet) { /* Check if this solution satisfies ALL CLAUSES in "clauses set" */
		return clausesSet.getNumberClause() == this.satisfiedClauses(clausesSet);
	}


	public int sameSatisfiedClausesAsLiteral(Clauses clausesSet, int literal) { /* Count number of satisfied clauses by "literal" already satisfied by this solution */
		int countSat = 0;
		int tempLiteral;
